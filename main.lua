...
----------------------------------------------------------
-- 🔍 ESP Highlight Aman (tidak ganggu Shift / Kill)
----------------------------------------------------------
...
-- Fungsi membuat highlight di dalam character (bukan workspace)
local function createHighlight(player, color)
    ...
    highlight.Parent = player.Character -- aman, tidak ganggu physics
        ...
        if player ~= LocalPlayer then
            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                if not highlights[player] then
                    -- Warna default merah (bisa diganti)
...
-- Hapus highlight jika player keluar
...
-- Toggle ESP di UI Rayfield (sebelum Players Tab)
