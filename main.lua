...
-- ✈️ FLY TOGGLE (dengan GUI Naik/Turun + Slider Kecepatan)
...
local function createFlyGui()
    ...
    container.Position = UDim2.new(0.985, 0, 0.5, 0)
    container.Size = UDim2.new(0, 120, 0, 220)
    ...
    local function setUp(b) flyUpPressed = b end
    local function setDown(b) flyDownPressed = b end
